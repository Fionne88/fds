...
$searchdata=$_POST['searchdata'];
        $sql = "SELECT * FROM tbl_food where itemName like '%$searchdata%' ";
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="price-btn-block"> <span class="price">RM <?php echo $row['itemPrice'];?></span> <?php if($_SESSION['fdsuserid']==""){?>
