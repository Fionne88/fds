...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update tbl_admin set password='$password'  where  email='$email' && mobileNumber='$contactno' ");
   if($query)
   {
...
<head>
    ...
    <title>FoodXpress | Reset Password</title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">FoodXpress | Admin  Reset Password</h2>
