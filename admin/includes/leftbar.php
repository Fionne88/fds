                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <?php
$admid=$_SESSION['fdsadminid'];
$ret=mysqli_query($con,"select adminName from tbl_admin where id='$admid'");
...
?>
                ...
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Restaurant</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="add-restaurant.php">Add Restaurant</a></li>
                        <li><a href="manage-restaurant.php">Manage Restaurant</a></li>
