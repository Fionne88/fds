                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query=mysqli_query($con,"Select * from tbl_orderdetails");
...
<a class="text-muted text-uppercase m-b-20" href="all-order.php" style="font-size: 20px"><strong>Total Order</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query1=mysqli_query($con,"Select * from  tbl_orderdetails where orderFinalStatus is null");
...
<a class="text-muted text-uppercase m-b-20" href="notconfirmedyet.php" style="font-size: 20px"><strong>New Order</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query2=mysqli_query($con,"Select * from  tbl_orderdetails where orderFinalStatus ='Order Confirmed'");
...
?>
      <a class="text-muted text-uppercase m-b-20" href="confirmed-order.php" style="font-size: 20px"><strong>Confirmed Order</strong></a>                          
         ...
         <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query3=mysqli_query($con,"Select * from  tbl_orderdetails where orderFinalStatus ='Food being Prepared'");
...
<a class="text-muted text-uppercase m-b-20" href="foodbeingprepared.php" style="font-size: 20px"><strong>Food being Prepared</strong></a>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
                                <?php $query5=mysqli_query($con,"Select * from  tbl_orderdetails where orderFinalStatus ='Food Delivered'");
...
<a class="text-muted text-uppercase m-b-20" href="food-delivered.php" style="font-size: 20px"><strong>Total Food Deliver</strong></a>
           ...
           <div class="col-lg-4">
                        <div class="ibox ">
                            <div class="ibox-title">
<?php $query1=mysqli_query($con,"Select * from  tbl_orderdetails where orderFinalStatus='Order Cancelled'");
$notconfirmedorder=mysqli_num_rows($query1);
?>
