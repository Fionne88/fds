...
else
{
    ...
    $query=mysqli_query($con, "insert into tbl_food(categoryName,itemName,itemPrice,itemDesc,itemQty,image,restName) value('$fcat','$itemname','$price','$description','$quantity','$itempic','$restname')");
    if ($query) {
              ...
              <option value="<?php echo $row['categoryName'];?>"><?php echo $row['categoryName'];?></option>
                  <?php } ?>  
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Restaurant Name:</label>
                                                <div class="col-sm-10"><select name='restname' id="restname" class="form-control white_bg" required="true">
                                                <?php
                                                $query=mysqli_query($con,"select * from  tbl_restaurant");
                                                while($row=mysqli_fetch_array($query))
                                                {
                                                ?>    
                                                <option value="<?php echo $row['restName'];?>"><?php echo $row['restName'];?></option>
                                                <?php } ?>  
                                                </select></div>
                                            </div>
                                        </fieldset>
