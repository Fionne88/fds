...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tbl_restaurant set restName='$restname',restAddress='$restaddress' where id='$rid'" );
    if ($query) {
    $msg="Restaurant has been Updated.";
  }
  else
    {
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                           ...
                           <?php
 $rid=$_GET['editid'];
$ret=mysqli_query($con,"select * from tbl_restaurant where id='$rid'");
$cnt=1;
    ...
    echo $msg;
                                    ...
                                    <fieldset>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Restaurant Name:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="restname" value="<?php  echo $row['restName'];?>"></div>
                                            </div>
                                            
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Restaurant Address:</label>
                                                <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="restaddress" value="<?php  echo $row['restAddress'];?>">
                                                </div>
                                            </div>
                                        </fieldset>
