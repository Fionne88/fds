...
$query=mysqli_query($con,"select ID from tbl_admin where id='$adminid' and password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbl_admin set password='$newpassword' where id='$adminid'");
...
<body>
 ...
 <p style="font-size:16px; color:red;"> <?php if($msg){
    echo $msg;
                          ...
                          <?php
$adminid=$_SESSION['fdsadminid'];
$ret=mysqli_query($con,"select * from tbl_admin where id='$Dadminid'");
$cnt=1;
