...
if(isset($_POST['submit']))
  {
   ...
   $itempic=$_FILES["itemimages"]["name"];
    $query=mysqli_query($con, "update tbl_food set categoryName='$fcat',itemName='$itemname',itemPrice='$price',itemDesc='$description',itemQty='$quantity',restName='$restname' where id='$cid'" );
    if ($query) {
                                    ...
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Food Category:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Description:</label>
                                                <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="description" value="<?php  echo $row['itemDesc'];?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Price:</label>
                                             ...
                                             <div class="form-group row"><label class="col-sm-2 col-form-label">Restaurant Name:</label>
                                                <div class="col-sm-10"><input name='restname' id="restname" class="form-control white_bg" value="<?php  echo $row['restName'];?>">
                                            </div>
                                        </fieldset>
