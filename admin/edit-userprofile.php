...
<body>
    ...
    echo $msg;
                      ...
                      <?php
$sid=$_GET['userid'];
$ret=mysqli_query($con,"select * from tbl_user where id='$sid'");
$cnt=1;
                                    ...
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">First Name:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Email:</label>
                                                <div class="col-sm-10">
                                                 <input type="email" class="form-control" name="email" readonly="true" value="<?php  echo $row['rmail'];?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Registration Date:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="price" readonly="true" value="<?php  echo $row['registrationDate'];?>"></div>
                                            </div>
