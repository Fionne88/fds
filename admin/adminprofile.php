...
if(isset($_POST['submit']))
  {
    $adminid=$_SESSION['fdsadminid'];
    $adminname=$_POST['adminname'];
    $mobno=$_POST['mobilenumber'];
    $email=$_POST['email'];
  
  
     $query=mysqli_query($con, "update tbl_admin set adminName ='$adminname', mobileNumber='$mobno', email='$email' where id='$adminid'");
    if ($query) {
...
<p style="font-size:16px; color:red;"> <?php if($msg){
    echo $msg;
                           ...
                           <?php
$adminid=$_SESSION['fdsadminid'];
$ret=mysqli_query($con,"select * from tbl_admin where id='$adminid'");
$cnt=1;
                                    ...
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Admin Name:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Admin Registration date:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="adminrd" readonly="true" value="<?php  echo $row['registrationDate'];?>"></div>
                                            </div>
