...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
        ...
        $query=mysqli_query($con,"select id from tbl_admin where email='$email' and mobileNumber='$contactno' ");
...
<head>
    ...
    <title>FoodXpress | Admin Forgot Password</title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="font-bold">FoodXpress | Admin  Forgot Password</h2>
