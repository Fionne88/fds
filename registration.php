...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select email from tbl_user where email='$email' || mobileNumber='$contno'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email or Contact Number already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into tbl_user(firstName, lastName, mobileNumber, email, password) value('$fname', '$lname','$contno', '$email', '$password' )");
    if ($query) {
                              ...
                              <form action="" name="signup" method="post" onsubmit="return checkpass();">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="email" class="form-control" id="email" aria-describedby="emailHelp" name="email" required="true"> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Mobile Number</label>
                                       <input class="form-control" type="text" value="" id="mobilenumber" name="mobilenumber" required="true" maxlength="10" pattern="[0-9]{10}"> 
                                    </div>
                                    <div class="form-group col-sm-6">
