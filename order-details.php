                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                              ...
                              Your Orders of Delicious hot food! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular" aria-expanded="true">
...
$oid=$_GET['orderid'];
$query=mysqli_query($con,"select tbl_food.image,tbl_food.itemName,tbl_food.itemDesc,tbl_food.itemPrice,tbl_food.itemQty,tbl_orders.foodId from tbl_orders join tbl_food on tbl_food.id=tbl_orders.foodId where tbl_orders.userId='$userid' and tbl_orders.isOrderPlaced=1 and tbl_orders.orderNumber='$oid'");
...
$grandtotal+=$total;
 ...
 ?>
   ...
   <?php
$query=mysqli_query($con,"select * from  tbl_orderdetails  where orderNumber='$oid'");
while($row=mysqli_fetch_array($query))
              { ?>
...
<hr />
<p><b>Flat No / Building No.:</b> <?php echo $row['buildingNo']?></p>
