...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p><span class="primary-color"><strong>Find Your Favourite Food Here..</strong></span> </div>
            </p>
...
// Getting total number of pages
        $total_pages_sql ="SELECT COUNT(*) FROM tbl_food";
        $result = mysqli_query($con,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);
        $sql = "SELECT * FROM tbl_food LIMIT $offset, $no_of_records_per_page";
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="product-name"><?php echo substr($row['itemDesc'],0,50);?></div>
