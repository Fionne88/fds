...
$query=mysqli_query($con,"select id from tbl_user where id='$userid' and password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbl_user set password='$newpassword' where id='$userid'");
